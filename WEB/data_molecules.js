...
addMol("C8H10", "C", "sp²", ["平面/四面體","Planar/Tetra"], "120°", "-47.8", "139", [], [], {
    "C8H10|乙苯": { 
        ...
        symVectors: { "s": [0, 0, 1] },
        mp: "-95", bp: "136", 
        atoms: [{elem:"C",x:73,y:0,z:28},{elem:"C",x:7,y:0,z:16},{elem:"C",x:-24,y:-54,z:10},{elem:"C",x:-24,y:54,z:10},{elem:"C",x:110,y:0,z:-30},{elem:"C",x:-86,y:-54,z:-2},{elem:"C",x:-86,y:54,z:-2},{elem:"C",x:-116,y:0,z:-8},{elem:"H",x:85,y:-39,z:55},{elem:"H",x:85,y:39,z:55},{elem:"H",x:0,y:-97,z:14},{elem:"H",x:0,y:97,z:14},{elem:"H",x:101,y:40,z:-57},{elem:"H",x:158,y:0,z:-19},{elem:"H",x:101,y:-40,z:-57},{elem:"H",x:-110,y:-97,z:-6},{elem:"H",x:-110,y:97,z:-6},{elem:"H",x:-164,y:0,z:-17}], 
        bonds: [[0,1],[0,4],[0,8],[0,9],[1,2,"double"],[1,3],[2,5],[2,10],[3,6,"double"],[3,11],[4,12],[4,13],[4,14],[5,7,"double"],[5,15],[6,7],[6,16],[7,17]] 
    },
    "C8H10|鄰二甲苯": { 
        pg: "C2v", 
        // 鄰位甲基在 y=31 與 y=-31，故 C2 軸需設定在水平 X 軸 [1, 0, 0] 才能左右翻轉對稱
        symVectors: { "C2": [1, 0, 0], "sv": [0, 0, 1], "sv2": [0, 1, 0] },
        mp: "-25", bp: "144", 
        atoms: [{elem:"C",x:10,y:-31,z:0},{elem:"C",x:10,y:31,z:0},{elem:"C",x:-44,y:-63,z:0},{elem:"C",x:-44,y:63,z:0},{elem:"C",x:68,y:-66,z:0},{elem:"C",x:68,y:66,z:0},{elem:"C",x:-98,y:-31,z:0},{elem:"C",x:-98,y:31,z:0},{elem:"H",x:-45,y:-112,z:0},{elem:"H",x:-45,y:112,z:0},{elem:"H",x:95,y:-56,z:40},{elem:"H",x:95,y:-56,z:-40},{elem:"H",x:60,y:-115,z:0},{elem:"H",x:95,y:55,z:40},{elem:"H",x:60,y:115,z:0},{elem:"H",x:94,y:56,z:-40},{elem:"H",x:-141,y:-56,z:0},{elem:"H",x:-141,y:56,z:0}], 
        bonds: [[0,1],[0,2,"double"],[0,4],[1,3,"double"],[1,5],[2,6],[2,8],[3,7],[3,9],[4,10],[4,11],[4,12],[5,13],[5,14],[5,15],[6,7,"double"],[6,16],[7,17]] 
    },
    "C8H10|間二甲苯": { 
        pg: "C2v", 
        // 間位甲基對稱中心在 Y 軸 [0, 1, 0]
        symVectors: { "C2": [0, 1, 0], "sv": [0, 0, 1], "sv2": [1, 0, 0] },
        mp: "-47.8", bp: "139", 
        atoms: [{elem:"C",x:-54,y:6,z:0},{elem:"C",x:54,y:6,z:0},{elem:"C",x:0,y:37,z:0},{elem:"C",x:-54,y:-57,z:0},{elem:"C",x:54,y:-57,z:0},{elem:"C",x:0,y:-88,z:0},{elem:"C",x:-112,y:39,z:0},{elem:"C",x:112,y:39,z:0},{elem:"H",x:0,y:86,z:0},{elem:"H",x:-96,y:-82,z:0},{elem:"H",x:96,y:-82,z:0},{elem:"H",x:0,y:-137,z:0},{elem:"H",x:-148,y:13,z:-22},{elem:"H",x:-126,y:49,z:46},{elem:"H",x:-108,y:82,z:-25},{elem:"H",x:108,y:82,z:-25},{elem:"H",x:148,y:13,z:-22},{elem:"H",x:126,y:49,z:46}], 
        bonds: [[0,2,"double"],[0,3],[0,6],[1,2],[1,4,"double"],[1,7],[2,8],[3,5,"double"],[3,9],[4,5],[4,10],[5,11],[6,12],[6,13],[6,14],[7,15],[7,16],[7,17]] 
    },
    "C8H10|對二甲苯": { 
        pg: "D2h", 
        // 對位高度對稱，定義三個維度的 C2 與中心 i
        symVectors: { "C2x": [1, 0, 0], "C2y": [0, 1, 0], "C2z": [0, 0, 1], "sh": [0, 0, 1], "i": [0, 0, 0] },
        mp: "13", bp: "138", 
        atoms: [{elem:"C",x:63,y:0,z:0},{elem:"C",x:-63,y:0,z:0},{elem:"C",x:31,y:-54,z:0},{elem:"C",x:-31,y:-54,z:0},{elem:"C",x:31,y:54,z:0},{elem:"C",x:-31,y:54,z:0},{elem:"C",x:130,y:0,z:0},{elem:"C",x:-130,y:0,z:0},{elem:"H",x:55,y:-97,z:0},{elem:"H",x:-55,y:-97,z:0},{elem:"H",x:55,y:97,z:0},{elem:"H",x:-55,y:97,z:0},{elem:"H",x:148,y:40,z:-23},{elem:"H",x:148,y:-40,z:-23},{elem:"H",x:147,y:0,z:46},{elem:"H",x:-148,y:40,z:23},{elem:"H",x:-148,y:-40,z:23},{elem:"H",x:-147,y:0,z:-46}], 
        bonds: [[0,2,"double"],[0,4],[0,6],[1,3,"double"],[1,5],[1,7],[2,3],[2,8],[3,9],[4,5,"double"],[4,10],[5,11],[6,12],[6,13],[6,14],[7,15],[7,16],[7,17]] 
    }
});
...
addMol("C6H6|苯|Benzene", "C", "sp²", ["平面","Planar"], "120°", "5.5", "80.1", [{elem:"C",x:-55,y:31,z:0},{elem:"C",x:-54,y:-32,z:0},{elem:"C",x:0,y:63,z:0},{elem:"C",x:0,y:-63,z:0},{elem:"C",x:54,y:32,z:0},{elem:"C",x:55,y:-31,z:0},{elem:"H",x:-97,y:55,z:0},{elem:"H",x:-96,y:-57,z:0},{elem:"H",x:-1,y:112,z:0},{elem:"H",x:1,y:-112,z:0},{elem:"H",x:96,y:57,z:0},{elem:"H",x:97,y:-55,z:0}], [[0,1,"double"],[0,2],[0,6],[1,3],[1,7],[2,4,"double"],[2,8],[3,5,"double"],[3,9],[4,5],[4,10],[5,11]], null, null, "D6h");
addMol("HCHO|甲醛|Formaldehyde", "C", "sp3", ["四面體","Tetrahedral"], "109.5°", "-92", "-19.5", [{elem:"O",x:55,y:0,z:0},{elem:"C",x:-1,y:0,z:0},{elem:"H",x:-27,y:-11,z:-40},{elem:"H",x:-27,y:11,z:40}], [[0,1,"double"],[1,2],[1,3]], null, null, "C2v");
addMol("CH3CHO|乙醛|Acetaldehyde", "C", "sp3", ["四面體","Tetrahedral"], "109.5°", "-123.4", "20.8", [{elem:"O",x:81,y:-14,z:0},{elem:"C",x:-27,y:-12,z:0},{elem:"C",x:35,y:15,z:0},{elem:"H",x:-51,y:3,z:40},{elem:"H",x:-24,y:-61,z:0},{elem:"H",x:-51,y:3,z:-40},{elem:"H",x:36,y:65,z:0}], [[0,2,"double"],[1,2],[1,3],[1,4],[1,5],[2,6]], null, null, "Cs");
addMol("CH3COC2H5|丁酮|Butanone", "C", "sp²", ["平面/四面體","Mixed"], "120°", "-86", "79.6", [{elem:"C",x:0,y:0,z:0},{elem:"O",x:0,y:50,z:0},{elem:"C",x:45,y:-30,z:0},{elem:"C",x:-45,y:-30,z:0},{elem:"C",x:-85,y:0,z:0},{elem:"H",x:45,y:-70,z:0},{elem:"H",x:75,y:-10,z:25},{elem:"H",x:75,y:-10,z:-25},{elem:"H",x:-45,y:-70,z:0},{elem:"H",x:-45,y:-30,z:40},{elem:"H",x:-85,y:40,z:0},{elem:"H",x:-115,y:-20,z:25},{elem:"H",x:-115,y:-20,z:-25}], [[0,1,"double"],[0,2],[0,3],[2,5],[2,6],[2,7],[3,4],[3,8],[3,9],[4,10],[4,11],[4,12]], null, null, "Cs");
addMol("CH3CH2COOH|丙酸|Propanoic Acid", "C", "sp²", ["平面/四面體","Mixed"], "120°", "-20.5", "141.2", [{elem:"C",x:30,y:0,z:0},{elem:"O",x:30,y:50,z:0},{elem:"O",x:70,y:-25,z:0},{elem:"H",x:95,y:-5,z:0},{elem:"C",x:-15,y:-25,z:0},{elem:"C",x:-60,y:5,z:0},{elem:"H",x:-15,y:-65,z:0},{elem:"H",x:-15,y:-25,z:40},{elem:"H",x:-60,y:45,z:0},{elem:"H",x:-90,y:-15,z:25},{elem:"H",x:-90,y:-15,z:-25}], [[0,1,"double"],[0,2],[2,3],[0,4],[4,5],[4,6],[4,7],[5,8],[5,9],[5,10]], null, null, "Cs");
addMol("CH3COOH|乙酸|醋酸", "C", "sp²", ["平面/四面體","Planar/Tetra"], "120°/109°", "16.6", "117.9", [{elem:"O",x:-36,y:-57,z:0},{elem:"O",x:-66,y:41,z:0},{elem:"C",x:40,y:17,z:0},{elem:"C",x:-26,y:3,z:0},{elem:"H",x:61,y:-1,z:-41},{elem:"H",x:61,y:-2,z:40},{elem:"H",x:46,y:66,z:0},{elem:"H",x:-79,y:-67,z:0}], [[0,3],[0,7],[1,3,"double"],[2,3],[2,4],[2,5],[2,6]], null, null, "Cs");
addMol("HCOOCH3|甲酸甲酯|Methyl Formate", "C", "sp²", ["平面/四面體","Mixed"], "120°", "-99", "31.8", [{elem:"C",x:-15,y:0,z:0},{elem:"O",x:-15,y:50,z:0},{elem:"O",x:25,y:-25,z:0},{elem:"C",x:65,y:-25,z:0},{elem:"H",x:-50,y:-20,z:0},{elem:"H",x:65,y:-65,z:0},{elem:"H",x:95,y:0,z:25},{elem:"H",x:95,y:0,z:-25}], [[0,1,"double"],[0,2],[2,3],[0,4],[3,5],[3,6],[3,7]], null, null, "Cs");
